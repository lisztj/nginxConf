...
# RUN apt-get update && \
#     apt-get install -y ca-certificates nginx gcc g++ && \
#     wget http://labs.frickle.com/files/ngx_cache_purge-1.0.tar.gz tar xvzf ngx_cache_purge-1.0.tar.gz && \
#     rm -rf /var/lib/apt/lists/*
